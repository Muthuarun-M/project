...
# Generative AI API key - can be overridden with environment variable GENAI_API_KEY
GENAI_API_KEY = os.environ.get('GENAI_API_KEY', 'AIzaSyCr39suwL11VjDagkDoCsioja7BY_GPUvo')
